...
import com.uniovi.sdi2324310spring.pageobjects.*;
...
class Sdi2324310SpringApplicationTests {
	//Linux
	static String Geckodriver="/usr/local/bin/geckodriver";
	static String PathFirefox="/usr/local/bin/firefox-123.0/firefox/firefox";
	...
	public void PR12() {
		...
		PO_PrivateView.checkNumberOfElements(driver,"free","//tbody/tr",2);
	...
	public void PR13() {
		...
		PO_PrivateView.checkTextInPage(driver,checkText);
	...
	public void PR14() {
		...
		PO_PrivateView.clickElementNumberX(driver,"free","//*[@id='myNavbar']/ul[1]/li[2]",0);
		PO_PrivateView.clickElementNumberX(driver,"free","//a[contains(@href, 'mark/add')]",0);
		...
		PO_PrivateView.clickPageButton(driver,4);
	...
	public void PR15() {
		...
		PO_PrivateView.clickElementNumberX(driver, "free","//a[contains(@href, 'mark/list')]",0 );
		...
		PO_PrivateView.clickElementNumberX(driver, "free", "//td[contains(text(), 'Nota sistemas distribuidos')]/following-sibling::*/a[contains(@href, 'mark/delete')]",0);
